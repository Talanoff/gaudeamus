        ...
        <div class="row">
            <div class="col-md-8">
                ...
                @if($material->hasMedia('book'))
                    ...
                    <label for="file" class="form-control-label">Заменить файл с материалом </label>
                @else
            ...
            <div class="col-md-4">
                <image-uploader name="material" image-id="{{ optional($material->getFirstMedia('material'))->id }}" src="{{ $material->getFirstMediaUrl('material') }}"></image-uploader>
            </div>
        </div>
        <div class="mt-4">
