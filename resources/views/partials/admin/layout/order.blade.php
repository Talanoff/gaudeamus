<div class="col-auto align-self-center">
    <form action="{{ route('admin.reorder', $model) }}" method="post">
        ...
        <div class="mb-1">
            <button name="direction" value="moveOrderUp" class="btn btn-link text-dark p-0" title="{{ __('Move one up') }}">
            ...
            <button name="direction" value="moveOrderDown" class="btn btn-link text-dark p-0" title="{{ __('Move one down') }}">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18">
                    <path fill="none" d="M0 0h24v24H0z"/>
                    <path
        ...
        <div>
            <button name="direction" value="moveToStart" class="btn btn-link text-dark p-0" title="{{ __('Move to start') }}">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18">
                    <path fill="none" d="M0 0H24V24H0z"/>
                    <path
            ...
            <button name="direction" value="moveToEnd" class="btn btn-link text-dark p-0" title="{{ __('Move to end') }}">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18">
                    <path fill="none" d="M0 0H24V24H0z"/>
                    <path
